...
"[project]/components/dashboard/project-table.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectTable({ data, compact = false }) {
    ...
    const [sortField, setSortField] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Project name");
    ...
    const filteredAndSorted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectTable.useMemo[filteredAndSorted]": ()=>{
            let result = [
                ...data
            ];
            // Filter by search
            if (search) {
                ...
                result = result.filter({
                    "ProjectTable.useMemo[filteredAndSorted]": (p)=>p["Project name"]?.toLowerCase().includes(searchLower) || p.Agency?.toLowerCase().includes(searchLower) || p.Portfolio?.toLowerCase().includes(searchLower)
                }["ProjectTable.useMemo[filteredAndSorted]"]);
            }
            // Sort
            result.sort({
                "ProjectTable.useMemo[filteredAndSorted]": (a, b)=>{
                    let aVal;
                    let bVal;
...
_s(ProjectTable, "9JC3o8JX4pfbKXnKzs3qTOSuaPM=");
_c = ProjectTable;
var _c;
...
"[project]/components/dashboard/project-table.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/dashboard/project-table.tsx [app-client] (ecmascript)"));
}),
...
//# sourceMappingURL=_069lq4_._.js.map